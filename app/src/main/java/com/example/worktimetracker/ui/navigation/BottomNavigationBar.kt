...
val navigationItems = listOf(
    NavigationItem(Screen.Dashboard, Icons.Default.Home, "Dashboard"),
    NavigationItem(Screen.Map, Icons.Default.LocationOn, "Map"),
    NavigationItem(Screen.Entries, Icons.Default.List, "Entries"),
